...
export default function AddCustomerModal() {
  ...
  return (
    <Dialog.Root>
      {/*Button Add  */}
      <Dialog.Trigger className="bg-white flex items-center gap-2 text-[#1243AF] px-4 sm:px-8 py-1 rounded-md mt-2 cursor-pointer hover:bg-gray-300 duration-300 transition-all me-6 z-50">
        Add Basket <FaPlus className="text-sm" />
      </Dialog.Trigger>

      {/*Taps  */}
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 bg-[#1234AF]/50 z-40" />
