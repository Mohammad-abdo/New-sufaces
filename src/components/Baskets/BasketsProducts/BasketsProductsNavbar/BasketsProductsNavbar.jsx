...
export default function BasketsProductsNavbar() {
  ...
  function convertBasketToCatalog() {
    setSpinner(true)
    axios.post(`${API_BASE_URL}baskets/${BasketsId}/convert-to-catalog`,{
      name: data?.name,
      template_id : 1
    } ,{
      headers: {
  ...
  return (
    <nav>
      <div className="h-[175px] rounded-2xl fixed top-2 right-2 left-2 lg:left-[290px] z-40 bg-white">
        <div
          ...
          <div className="mt-2 w-[95%] mx-auto">
            <div className="flex justify-between items-center">
              ...
              <div className="me-6 flex">
                ...
                <button onClick={convertBasketToCatalog} className="bg-white cursor-pointer textColor rounded-lg px-4 py-1">
                  {spinner ? <FaSpinner className="animate-spin text-2xl text-blue-500"/> : "Convert to Catalog +"}
                </button>
              </div>
            </div>
