...
import UploadImage from "../AddTemplate/UploadImage";
const SearchBar = React.lazy(() => import("../../SearchBar/SearchBar"));
const AddTemplate = React.lazy(() => import("../AddTemplate/AddTemplate"));
...
export default function TemplateNavbar() {
  ...
  return (
    <nav>
      <div className="rounded-2xl fixed pt-2 right-2 left-72 z-30">
        <div
        ...
        >
          ...
          <div className="mt-2 w-[95%] mx-auto">
            <div className="flex justify-between items-center mx-4">
              <h1 className="text-4xl ms-6 text-white font-bold">Template</h1>
