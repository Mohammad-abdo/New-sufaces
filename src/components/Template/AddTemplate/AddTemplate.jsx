...
export default function AddTemplate() {
  ...
  return (
    <Dialog.Root>
      {/*Button Add*/}
      <Dialog.Trigger className="bg-white flex items-center gap-2 text-[#1243AF] px-8 py-1 rounded-md mt-2 cursor-pointer hover:bg-gray-300 duration-300 transition-all z-50">
